...
namespace glacial_inferno.Items.Weapons.Ranged
{
    public class InfernoBlower : ModItem
    {
        ...
        //A weapon that "blows" bits of Hot Air towards the enemy.
        //Shoots very many small projectiles that simulate wind
        //when projectiles hit they Warmth the enemy and "blow them back" 
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile projectile = Main.projectile[Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<InfernoBlowerProjectile>(), damage, knockback, player.whoAmI)];
